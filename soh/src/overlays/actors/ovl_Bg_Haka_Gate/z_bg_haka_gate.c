...
void BgHakaGate_StatueTurn(BgHakaGate* this, PlayState* play) {
    ...
    if (turnFinished) {
        ...
        this->vTurnRateDeg10 = CVarGetInteger(CVAR_ENHANCEMENT("FasterBlockPush"), 0) * 2 + strengthBoost * 2;
        this->vTurnAngleDeg10 = 0;
        this->vTimer = 5 - ((CVarGetInteger(CVAR_ENHANCEMENT("FasterBlockPush"), 0) * 3) / 5) - (strengthBoost * 3) / 5;
        this->actionFunc = BgHakaGate_StatueIdle;
        this->dyna.unk_150 = 0.0f;
    }
