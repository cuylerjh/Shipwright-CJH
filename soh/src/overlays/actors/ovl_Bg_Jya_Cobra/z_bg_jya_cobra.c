...
void func_80896950(BgJyaCobra* this, PlayState* play) {
    ...
    if (this->dyna.unk_150 > 0.001f) {
        this->unk_168++;
        if (this->unk_168 >= (15 - CVarGetInteger(CVAR_ENHANCEMENT("FasterBlockPush"), 0) * 2 - strengthBoost * 2)) {
...
void func_808969F8(BgJyaCobra* this, PlayState* play) {
    ...
    this->unk_170 = 0;
    this->unk_172 = true;
    this->unk_16E = CVarGetInteger(CVAR_ENHANCEMENT("FasterBlockPush"), 0) * 20 + strengthBoost * 20;
}
